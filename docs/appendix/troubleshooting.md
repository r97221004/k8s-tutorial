...
|---------|--------------|-------------|
| Pod **`Pending`** | no node has room, or PVC unbound | `describe pod` → Events; check [resources](../running-and-operating/resources.md) requests and [PVC/StorageClass](../config-and-data/volumes.md) |
